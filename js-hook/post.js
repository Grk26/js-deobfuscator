...
if ( windowlocation != window.location){
	print ("\n//location '" + window.location + "' where windowlocation = '" + windowlocation + "'");
}
if(documenttxt){
	print ('\n//document.write (s)\n');
	print (documenttxt);
...
for (var i in this){
    ...
    if (typeof this[i] == 'string' && i != 'documenttxt' && i != 'i' && i != 'txtzzz'){
        ...
        /*if (this[i].toSource().length < 100000){
            finalvars[finalcount] = '//var ' + i; //' = ' + this[i].toSource();
            finalcount++;
        }*/
...
/*print ('//final variable enumeration');
